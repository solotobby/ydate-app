    ...
    <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
        ...
        <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
            ...
            <div class="flex items-center gap-1"> 
                ...
                <div id="logo">
                    <a href="{{url('home')}}"> 
                        <img src="{{asset('assets/images/logo.png')}}" alt="" class="w-28 md:block hidden dark:!hidden">
                        <img src="{{asset('assets/images/logo-light.png')}}" alt="" class="dark:md:block hidden">
                        <img src="{{asset('assets/images/logo-mobile.png')}}" class="hidden max-md:block w-20 dark:!hidden" alt="">
                        <img src="{{asset('assets/images/logo-mobile-light.png')}}" class="hidden dark:max-md:block w-20" alt="">
                    </a>
                </div>
